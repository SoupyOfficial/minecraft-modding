...
//            event.getRegistry().register(BlockMod.CASTLE_WALL);
        ...
        {
            event.registerLayerDefinition(ZomboModel.LAYER_LOCATION, ZomboModel::createBodyLayer);
            ItemBlockRenderTypes.setRenderLayer(BlockMod.TRANSPARENT_BLOCK, RenderType.translucent());
